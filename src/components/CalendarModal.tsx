...
const CALENDAR_URL = 'https://calendly.com/anshul-aigeniq/25-minute-discovery-call'
  ...
  return (
    <div className="ct-modal-backdrop" onClick={onClose} role="dialog" aria-modal="true" aria-label="Book a clarity call">
      <div className="ct-modal" onClick={e => e.stopPropagation()}>
        <button type="button" className="ct-modal-close" onClick={onClose} aria-label="Close calendar">
